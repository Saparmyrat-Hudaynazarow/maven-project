...
import com.song.exception.response.SimpleErrorResponse;
import com.song.exception.response.ValidationErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<SimpleErrorResponse> handleSongMetadataAlreadyExist(MetadataAlreadyExistException ex) {
        SimpleErrorResponse errorResponse = new SimpleErrorResponse(
                ex.getMessage(),
